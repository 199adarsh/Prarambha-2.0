...
export function playHoverSound() {
  ...
  try {
    ...
    gain.gain.setValueAtTime(0.002, ctx.currentTime); // Very quiet hover
...
export function playPopSound() {
  ...
  try {
    ...
    gain.gain.setValueAtTime(0.1, ctx.currentTime); // Quiet pop
    gain.gain.exponentialRampToValueAtTime(0.01, ctx.currentTime + 0.1);
...
export function playScrollTickSound() {
  ...
  try {
    ...
    // Clicky mechanical tick (like a gear or scroll wheel)
    osc.type = 'square';
    osc.frequency.setValueAtTime(100, ctx.currentTime);

    gain.gain.setValueAtTime(0.015, ctx.currentTime); // Very quiet scroll tick
