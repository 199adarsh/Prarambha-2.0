      ...
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        <div className="flex items-center justify-center gap-3 mb-8 md:mb-10">
          {["⚔", "💎", "🎮"].map((icon) => (
            <span
              key={icon}
              className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center border border-white/20 rounded-full text-lg md:text-xl bg-black/40 backdrop-blur-sm shadow-[0_0_15px_rgba(255,255,255,0.1)]"
            >
              {icon}
            </span>
          ))}
        ...
        <p className="font-sans text-xs text-gray-500 mt-8">
          Round 1 · Free to Participate · 24-Hour Online Hackathon
        </p>
      </div>
    </section>
  );
