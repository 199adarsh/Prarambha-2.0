              ...
              {NAV_LINKS.map((link) => {
                ...
                return (
                  <a
                    ...
                    className={`font-pixel text-[0.6rem] lg:text-xs tracking-widest uppercase px-3 py-2 rounded-md transition-all duration-300 ${
                      isActive
              ...
              {NAV_LINKS.map((link) => {
                ...
                return (
                  <a
                    ...
                    className={`font-pixel text-sm tracking-widest uppercase block px-4 py-3 rounded-md ${
                      isActive
